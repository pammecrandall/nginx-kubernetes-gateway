...
var _ = Describe("EventHandler", func() {
	...
	Describe("Process the Gateway API resources events", func() {
		DescribeTable("A batch with one event",
			...
			Entry("HTTPRoute upsert", &events.UpsertEvent{Resource: &v1alpha2.HTTPRoute{}}),
			Entry("Gateway upsert", &events.UpsertEvent{Resource: &v1alpha2.Gateway{}}),
			Entry("GatewayClass upsert", &events.UpsertEvent{Resource: &v1alpha2.GatewayClass{}}),
			Entry("HTTPRoute delete", &events.DeleteEvent{Type: &v1alpha2.HTTPRoute{}, NamespacedName: types.NamespacedName{Namespace: "test", Name: "route"}}),
			Entry("Gateway delete", &events.DeleteEvent{Type: &v1alpha2.Gateway{}, NamespacedName: types.NamespacedName{Namespace: "test", Name: "gateway"}}),
			Entry("GatewayClass delete", &events.DeleteEvent{Type: &v1alpha2.GatewayClass{}, NamespacedName: types.NamespacedName{Name: "class"}}),
		)
	})
	...
	It("should process a batch with upsert and delete events for every supported resource", func() {
		...
		upserts := []interface{}{
			&events.UpsertEvent{Resource: &v1alpha2.HTTPRoute{}},
			&events.UpsertEvent{Resource: &v1alpha2.Gateway{}},
			&events.UpsertEvent{Resource: &v1alpha2.GatewayClass{}},
			&events.UpsertEvent{Resource: svc},
			&events.UpsertEvent{Resource: secret},
		}
		deletes := []interface{}{
			&events.DeleteEvent{Type: &v1alpha2.HTTPRoute{}, NamespacedName: types.NamespacedName{Namespace: "test", Name: "route"}},
			&events.DeleteEvent{Type: &v1alpha2.Gateway{}, NamespacedName: types.NamespacedName{Namespace: "test", Name: "gateway"}},
			&events.DeleteEvent{Type: &v1alpha2.GatewayClass{}, NamespacedName: types.NamespacedName{Name: "class"}},
